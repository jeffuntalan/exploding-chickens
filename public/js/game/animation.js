...
// CODE BELOW USED TO MOVE DECK AND A TARGET CARD
// TODO: MAKE ANIMATIONS WORK
//
// const deck = document.getElementById("draw_deck");
// const target = document.getElementById("randchick-2-3");
//
// new AnimationFrames({
//     delay: 1000,
//     duration: 500,
//     easing: 'sineInOut',
//     onprogress: (e) => {
//         target.style.transform = translate(e * (get_position(deck).x - get_position(target).x), e * (get_position(deck).y - get_position(target).y));
//     }
// });
